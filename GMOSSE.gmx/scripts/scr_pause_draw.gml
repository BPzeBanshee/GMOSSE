...
then draw_sprite_ext(global.pause_img,0,xview,yview,1,1,0,c_white,1) 
else switch tate_first
    {
    case 0: draw_sprite_ext(global.pause_img,0,xview,yview,1,1,0,c_white,1); break;
    case 90: draw_sprite_ext(global.pause_img,0,xview+240,yview,1,1,270,c_white,1); break;
    case 180: draw_sprite_ext(global.pause_img,0,xview+240,yview+320,1,1,180,c_white,1); break;
    case 270: draw_sprite_ext(global.pause_img,0,xview,yview+320,1,1,90,c_white,1); break;
    }
