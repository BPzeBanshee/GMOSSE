...
switch tate_first
    ...
    case 1: draw_sprite_ext(pause_img,0,xview+240,yview,1,1,270,c_white,1); break;
    case 2: draw_sprite_ext(pause_img,0,xview+240,yview+320,1,1,180,c_white,1); break;
    case 3: draw_sprite_ext(pause_img,0,xview,yview+320,1,1,90,c_white,1); break;
    }
